...
public class VectorTests {
  ...
  public void testVector() {
    ...
    assertEquals("line 1", set.loop());
    assertEquals("line 2", set.loop());
    assertEquals(" line 3 ", set.loop());
    assertEquals("line 4", set.loop());
  }
  ...
  public void testSQLActive() {
    ...
    assertEquals("'; exec master..xp_cmdshell 'ping 10.10.1.2'--", set.loop());
  }
  ...
  public void testSQLPassive() {
    ...
    assertEquals("'||(elt(-3+5,bin(15),ord(10),hex(char(45))))", set.loop());
  }
  ...
  public void testXML() {
    ...
    assertEquals("<![CDATA[<script>var n=0;while(true){n++;}</script>]]>", set.loop());
  }
  ...
  public void testXSS() {
    ...
    assertEquals(">\"><script>alert(\"XSS\")</script>&", set.loop());
  }
}
