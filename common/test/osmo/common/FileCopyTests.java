...
public class FileCopyTests {
  ...
  public void fileCopy() throws Exception {
    TestUtils.copyFiles("osmo/common/license.txt", targetDir);
  ...
  public void dirCopy() throws Exception {
    TestUtils.copyFiles("osmo/common/test-data1", targetDir);
  ...
  public void nestedDirCopy() throws Exception {
    TestUtils.copyFiles("osmo/common/test-data2", targetDir);
  ...
  public void invalidTarget() throws Exception {
    TestUtils.copyFiles("osmo/common/license.txt", targetDir);
    try {
      TestUtils.copyFiles("osmo/common/license.txt", targetDir+"/license.txt");
