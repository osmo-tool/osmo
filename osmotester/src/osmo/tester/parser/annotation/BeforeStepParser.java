...
/**
 * Parses {@link Pre} annotations from the given model object.
 *
 * @author Teemu Kanstren
 */
public class BeforeStepParser implements AnnotationParser {
  private static final Logger log = new Logger(BeforeStepParser.class);

  @Override
  public String parse(ParserResult result, ParserParameters parameters) {
    BeforeStep pre = (BeforeStep) parameters.getAnnotation();

    Method method = parameters.getMethod();
    String errors = "";
    Class<?>[] parameterTypes = method.getParameterTypes();
    String aName = "@"+BeforeStep.class.getSimpleName();
