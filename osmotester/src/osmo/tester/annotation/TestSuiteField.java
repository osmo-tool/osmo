 ...
 * will be set by the generator before starting test generation to contain a reference to the
 * {@link osmo.tester.generator.testsuite.TestSuite} object
 ...
 * the field should always be given a null value. After the value is set by the parser/generator,
 * if the reference in the model is changed it will have no impact on the test generation other than
